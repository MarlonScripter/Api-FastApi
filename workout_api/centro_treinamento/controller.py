...
async def post(
    ...
    centro_treinamento_out = CentroTreinamentoOut(id=uuid4(), **centro_treinamento_in.model_dump()) # type: ignore
...
async def query(id= UUID4, db_session:DatabaseDependency) ->CentroTreinamentoOut: # type: ignore
